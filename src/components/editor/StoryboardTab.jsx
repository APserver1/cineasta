...
import { ZoomIn, ZoomOut, Plus, Trash2, ChevronLeft, ChevronRight, PenTool, Eraser, Move, Layers, Eye, EyeOff, Film, Volume2, Clock, Play, Pause, Repeat, Pencil, Brush, Highlighter, SprayCan, Undo, Copy, Music, Zap, Scissors, MousePointer2, BoxSelect, Lasso, Wand, PaintBucket, Maximize, RotateCw, Download } from 'lucide-react';
    ...
    return (
        <div className="flex flex-col h-full bg-gray-100 border-l border-gray-300">
            ...
            <div className="shrink-0 border-t border-gray-200 bg-white">
                <div className="h-[250px] w-full flex items-center justify-center overflow-hidden" data-adsterra-slot="storyboard-referencia-inferior">
...
const StoryboardTab = ({ project, onUpdateProject }) => {
    ...
    }, [frames, dialogues, audioTracks, referenceTracks]);
    ...
    const handleReferenceMouseDown = (e, ref) => {
        ...
        setActiveElement({ type: 'reference', id: ref.id });
        setTool('transform');
    };
    ...
    useEffect(() => {
        ...
        if (isDraggingRuler || isDraggingPlayhead || draggingTimelineDialogue || draggingAudio || draggingReference || draggingFrameIndex !== null || resizingTarget) {
    ...
    }, [isDraggingRuler, isDraggingPlayhead, draggingTimelineDialogue, draggingAudio, draggingReference, draggingFrameIndex, dropTargetIndex, lastMouseX, pixelsPerSecond, frames, resizingTarget]);
                                    ...
                                    {Object.entries(BRUSH_PRESETS).map(([key, preset]) => {
                                        ...
                                        return (
                                            <button
                                                key={key}
                                                onClick={() => {
                                                    setActiveElement({ type: 'frame', id: null }); // Deselect reference if brush is clicked
                                                    setTool(key);
                                                }}
                                                title={preset.name}
                ...
                <div className="h-64 bg-white border-t border-gray-200 flex flex-col text-gray-600 select-none shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
                    ...
                    <div className="flex-1 flex overflow-hidden">
                        ...
                        {(() => {
                            ...
                            const totalDurationMs = Math.max(framesDurationMs, dialoguesEndMs, audioEndMs, referencesEndMs);
