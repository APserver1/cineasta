...
const TratamientoTab = ({ project, onUpdateProject, readOnly = false }) => {
  ...
  return (
    <div className="h-full w-full overflow-y-auto bg-gray-50 p-4 md:p-8" data-pins-surface="tratamiento" data-pins-type="scroll">
